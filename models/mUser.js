// Mongoose work with Schema's (which are later used to build models)
const mongoose = require("mongoose");
const utils = require("../utils");
const Schema = mongoose.Schema; // data description

// define blueprint (like a class)
// "_id" will be added automatically in MongoDB
const userSchema = new Schema({
  ...
  cart: {
    ...
    // with this document, relation tag ("ref: ...") is not mandatory
    items: [
      // array of...
      {
        productId: {
...
// you can create your own methods within the schema
// here => adding prods to the cart
